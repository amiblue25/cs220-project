...
5. If the damage from step 4 fails to reduce the enemy's HP to 0, the enemy counterattacks, reducing the player's HP by the enemy's attack power. The player cannot explicitly know the enemy's attack power. If the player's HP reaches 0, the game ends.
